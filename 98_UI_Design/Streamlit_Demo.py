    ...
    with col2: 
        ...
        if (st.session_state.counter==0):
            response = """Dear [Name], 
                        ...
                        Thank you for your email and for the heads up regarding SEC issues. I appreciate your guidance and will definitely check with Travis or Lance, or anyone suggested by them, should I encounter any reps or forms to be completed.
 
                        I am aware that ENA has an affiliated registered broker dealer, and I will keep that in mind should it be pertinent in any type of rep. 
                        ...
                        [Name]"""
            st.text_area("Generated Response: ", value=response, key='response_area', height=500)
